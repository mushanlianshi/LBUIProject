//
//  LBAlertQueueViewController.swift
//  LBSwift2024Demo
//
//  Created by liu bin on 2025/1/14.
//

import UIKit
import CLPopoverManager
...
/// 弹框队列
class LBAlertQueueViewController: UIViewController {
...
extension LBAlertQueueViewController {
    func initData() {
        do {
            let model = CLPopupModel()
            model.title = "翻牌弹窗 + 队列弹框"
...
extension LBAlertQueueViewController: UITableViewDataSource {
...
extension LBAlertQueueViewController: UITableViewDelegate {
