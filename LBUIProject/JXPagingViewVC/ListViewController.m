...
- (void)viewDidLoad {
    ...
    self.tableView.contentInset = UIEdgeInsetsMake(0, 0, UIApplication.sharedApplication.keyWindow.safeAreaInsets.top, 0);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    detailVC.view.backgroundColor = [UIColor lightGrayColor];
