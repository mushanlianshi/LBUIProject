...
private struct AssociatedKeys {
    ...
    static var didLayoutSubviewsBlockKey: UInt8 = 0
    
    /// 是不是自动布局后刷新渐变色的layer的key
    static var autoLayoutGradientLayerKey: UInt8 = 1
    /// 渐变色layer的key
    static var gradientLayerKey: UInt8 = 2
    
    
    /// 是不是自动布局后再刷新边框的key
    static var autoLayoutBorderLayerKey: UInt8 = 3
    /// 边框的layer
    static var borderShapeLayerKey: UInt8 = 4
    /// 边框的layer各种数字存储对象的key
    static var borderShapeModelKey: UInt8 = 5
    
    
    /// 是不是自动布局后再刷新形状的key
    static var autoLayoutCornerShapeLayerKey: UInt8 = 6
    /// 形状的layer各种数字存储对象的key
    static var cornerShapeModelKey:UInt8 = 7
}
