...
//    public static func blt_list_from_response222(response: Any?, convertKey: String, belowResult: Bool = true) -> [T]{
//        var list = [T]()
...
//            for dic in array {
//                if let model =  BLTConvertDataUtil<T>.convertDicToModel(dic: dic){
//                    list.append(model)
//                }
...
//}
//
//public struct BLTConvertDataUtil<T> {
//    
//    public static func convertDicToModel(dic: [String : Any]?, designatedPath: String? = nil) -> T?{
//        return nil
//    }
//}
//
...
//    //从后台接口返回里取一个列表数组  convertKey 字段  belowResult是不是result下面 默认yes  老接口直接在array下
//    public static func blt_list_from_response(response: Any?, convertKey: String, belowResult: Bool = true) -> [T]{
//        var list = [T]()
//        guard let res = response as? [String : Any] else { return list }
//        if belowResult{
//            guard let result = res["result"] as? [String : Any], let array = result[convertKey] as? [[String : Any]] else { return list }
...
//    
////    默认result下
//    public static func blt_model_from_response(response: Any?, designatedPath: String? = nil) -> T?{
...
//}
//
//extension BLTConvertData where T == Dictionary<AnyHashable, Any>{
