...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BLTIconFont/BLTIconFont.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CLPopoverManager/CLPopoverManager.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SMSwiftBasicKit/SMSwiftBasicKit.framework"
