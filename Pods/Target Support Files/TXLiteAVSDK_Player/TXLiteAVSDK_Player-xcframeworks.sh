...
install_xcframework "${PODS_ROOT}/TXLiteAVSDK_Player/TXLiteAVSDK_Player/TXFFmpeg.xcframework" "TXLiteAVSDK_Player" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
